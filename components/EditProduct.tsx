            ...
            {originalProductData?.sku_image && !uploaded && (
                ...
                <img
                    ...
                    <div className="flex justify-end space-x-2">
                        <button type="submit" className={`px-6 py-2.5 rounded-lg text-white ${isSubmitting ? "bg-gray-500 cursor-not-allowed" : "bg-black hover:bg-gray-800"} transition`} disabled={isSubmitting}>
